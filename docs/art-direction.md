...
- 暗面蜘蛛要偏“火星生态异常”而不是恐怖怪物：低多边形黑紫色八足轮廓、明显绿色眼点，腹部后半截可有少量绿色发光点作为黑暗识别花纹。火星蜘蛛不吐丝织网，不做蛛网、矿物丝、血腥、黏液或攻击姿态；当前设定没有蜘蛛巢穴、地下洞穴或黑色洞口。蜘蛛活动区不要使用大面积贴地熔岩/粒子云平面；如果后续重做地表裂缝，需要真实窄沟、凹陷边缘和岩壁厚度。
- Shader 视觉只能作为特殊镜头或特殊能量层使用，不能把主场景改成熔岩式红黑高对比风格。可借鉴 `fBm` 流动噪声、体积辉光、距离雾和轻微 film grain，用在虫洞、时空之门、沙尘暴、太阳表面、暗面异常和对话背景；主基地、角色、车辆和任务区继续保持低多边形工程科幻、清晰轮廓和温和火星探索感。
